    ...
    public class fZ : Figure
    {
        ...
        public override bool checkDown()
        {
            ...
            if (rotation == Rotation.rotation0  &&
                parent.field[a.X + 1, a.Y].brush == Black && parent.field[c.X + 1, c.Y].brush == Black &&
            ...
            return rotation == Rotation.rotation90  &&
                   parent.field[d.X + 1, d.Y].brush == Black && parent.field[c.X + 1, c.Y].brush == Black;
        }

        public override bool checkLeft()
        {
            //проверка при сдвиге фигуры влево, текущий поворот 0 или 180
            if (rotation == Rotation.rotation0  && a.Y > 0 &&
        ...
        public override bool checkRight()
        {
            ...
            if (rotation == Rotation.rotation0  &&
                d.Y < 9 && parent.field[d.X, d.Y + 1].brush == Black && parent.field[b.X, b.Y + 1].brush == Black)
                return true;
            //проверка при сдвиге фигуры вправо, текущий поворот 90 или 270
            return rotation == Rotation.rotation90  &&
                   a.Y < 9 && parent.field[a.X, a.Y + 1].brush == Black && parent.field[c.X, c.Y + 1].brush == Black;
        }
        ...
        public override bool checkUp()
        {
            try
            {
                ...
                if (rotation == Rotation.rotation0 
                    && parent.field[d.X - 1, d.Y].brush == Black &&
                    parent.field[c.X + 1, d.Y].brush == Black)
                    return true;
                // --//-- 90 или 270
